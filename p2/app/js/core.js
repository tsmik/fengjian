...
export const DIM_BG_COLORS=['#D6E4CC','#C8DCD8','#E2DDD5','#F0DECA','#E8D2D8','#EDE4C8','#CEDDE8','#DDD4E4','#D2DDD6','#E2E3C0','#DED5DF','#CADDD8','#CDDAE6'];
export const DIM_DEEP_COLORS=['#6B8C5A','#4A7A6E','#8A8078','#A07850','#9A6878','#9A8A50','#4A7A9A','#7A6890','#5A8A6A','#6B7A3A','#7A6088','#4A8078','#4A6E8A'];
